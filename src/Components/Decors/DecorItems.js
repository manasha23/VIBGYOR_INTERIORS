...
function Decor() {
  ...
  useEffect(() => {
    const getProducts = async () => {
      const q = query(userCollectionRef, where("Category", "==", "Decors"));
            ...
            <div className="xl:w-5/12 flex flex-col justify-between">
              ...
              <div className="sm:text-center lg:text-left lg:py-12 xl:py-24">
                ...
                <div className="text-gray-400 text-xl  font-bold mb-8 md:mb-12">
                  At Vibgyor, we’ve got a wide range of beautiful home decor
                  products for your home, which enhances its beauty and
                  environment. Check out all these beautiful items.
                </div>
              </div>
            </div>
